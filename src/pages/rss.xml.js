 ...
 * Hiện cả 64 món đều đã có, nên trên thực tế không món nào rớt.
 */
...
export async function GET(context) {
  ...
  return rss({
    ...
    description:
      ...
      'giỏ đi chợ tự tính khẩu phần, đồng hồ đếm giờ và bí quyết của người nấu lâu năm.',
    site: context.site,
    trailingSlash: true,
