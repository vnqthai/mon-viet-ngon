...
export const ART_COMPONENT: Record<string, string> = {
  ...
  'bun-mang-vit':         'ArtBunMangVit',
  'bun-sua':              'ArtBunSua',
  'bun-moc':              'ArtBunMoc',
  'bun-oc':               'ArtBunOc',
  'bun-oc-nguoi':         'ArtBunOcNguoi',
  'com-chay-cha-bong':    'ArtComChayChaBong',
  'com-lam':              'ArtComLam',
  'com-rang-dua-bo':      'ArtComRangDuaBo',
  'com-ruou':             'ArtComRuou',
  'xoi-dau-xanh':         'ArtXoiDauXanh',
  'xoi-ga':               'ArtXoiGa',
  'xoi-gac':              'ArtXoiGac',
  'xoi-ngu-sac':          'ArtXoiNguSac',
  'sua-chua-nep-cam':     'ArtSuaChuaNepCam',
  'banh-chung':           'ArtBanhChung',
  'banh-tet':             'ArtBanhTet',
  'banh-giay':            'ArtBanhGiay',
  'banh-duc-nong':        'ArtBanhDucNong',
  'banh-da-cua':          'ArtBanhDaCua',
  'cha-ca-that-lat':      'ArtChaCaThatLat',
  'bowl':                 'ArtBowl',
  'claypot':              'ArtClaypot',
  'plate':                'ArtPlate',
  'rolls':                'ArtRolls',
